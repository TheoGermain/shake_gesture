...
Packages with breaking changes:
 ...
 - [`shake_gesture` - `v2.0.0`](#shake_gesture---v200)
 - [`shake_gesture_android` - `v2.0.0`](#shake_gesture_android---v200)
 - [`shake_gesture_test_helper` - `v2.0.0`](#shake_gesture_test_helper---v200)
...
#### `shake_gesture` - `v2.0.0`

 - **BREAKING** **FEAT**: improve shake detection on Android.

#### `shake_gesture_android` - `v2.0.0`

 - **FEAT**: enhance shake detection logic with direction change tracking.
 - **BREAKING** **FEAT**: improve shake detection on Android.

#### `shake_gesture_test_helper` - `v2.0.0`
